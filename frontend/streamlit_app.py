...
st.markdown(
    ...
    .main .block-container {
        padding-top: 5.8rem; padding-bottom: 1.5rem;
    ...
    [data-testid="stSidebarUserContent"] { padding-top: 5.8rem; }
    ...
    .luad-navbar .luad-brand { color: #FFFFFF; font-weight: 900; font-size: 1.85rem; }
    .luad-navbar .luad-brand-divider { color: rgba(255,255,255,0.35); margin: 0 0.85rem; font-weight: 300; }
    .luad-navbar .luad-brand-sub { color: #93C5FD; font-weight: 600; font-size: 1.15rem; opacity: 0.9; }
    .luad-navbar nav a {
        color: #BFDBFE; text-decoration: none; font-size: 1.1rem; font-weight: 600;
    ...
    #home, #analysis, #results, #about { scroll-margin-top: 5.8rem; }
